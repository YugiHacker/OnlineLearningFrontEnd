...
export default function Post(props) {
    ...
    React.useEffect(() => {
        const response = async () => {
            const loadData = await request.get('PostVote/userId && postId?userId=' + props.userIdVote + '&postId=' + props.postId)
    ...
    return (
        <div>
            <div className="post">
                <div className="post--header">
                    <div className="post--header--right">
                        <img src="ew" className="post--user--image" alt="User" />
                        <div>
                            {isUpdating ?
                                <input
                                    type="text"
                            ...
                            <p className="post--date">created on {dateProps[0]} {dateProps[1]} </p>

                        </div>

                    </div>
                    {props.postId === props.userIdVote &&
                        <Dropdown
            ...
            <div className={isCommentShown ? "show" : "hide"}>
                <Comment postId={props.postId} userIdVote={props.userIdVote} />
